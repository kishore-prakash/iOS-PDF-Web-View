...
class FilesTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            fileURLs = fileURLs.filter{ $0.pathExtension == "pdf" }
            // process files
        } catch {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.performSegue(withIdentifier: "fileWebViewSegue", sender: fileURLs[indexPath.row].absoluteString)
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "fileWebViewSegue":
            let secondViewController = segue.destination as! WebViewVC
            secondViewController.urlToLoad = sender as? String
        default:
            break
        }
    }
